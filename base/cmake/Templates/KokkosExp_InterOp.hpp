...
struct python_view_type {
  using decayed_view_type = std::decay_t<ViewT>;
  static_assert(Kokkos::is_view<decayed_view_type>::value);

  using type =
      Kokkos::Impl::python_view_type_impl_t<typename decayed_view_type::array_type>;
};

...
def acosh(view):
    """
    Calculates an approximation to the inverse hyperbolic
    cosine for each element of the input view.

    Parameters
    ----------
    view : pykokkos view
           Input view whose elements each represent the area of a
           hyperbolic sector. Should have a floatint-point data type.

    Returns
    -------
    y : pykokkos view
        Output view, containing the inverse hyperbolic cosine of each element in the
    ...
    ndims = len(view.shape)
    if ndims > 2:
        raise NotImplementedError("acosh() ufunc only supports up to 2D views")

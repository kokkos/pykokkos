...
def cosh(view):
    """
    Calculates an approximation to the hyperbolic
    cosine for each element of the input view.

    Parameters
    ----------
    view : pykokkos view
           Input view whose elements each represent a hyperbolic
           angle. Should have a floatint-point data type.

    Returns
    -------
    y : pykokkos view
        Output view, containing the hyperbolic cosine of each element in the
    ...
    ndims = len(view.shape)
    if ndims > 2:
        raise NotImplementedError("cosh() ufunc only supports up to 2D views")

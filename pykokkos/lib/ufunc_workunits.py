        ...
        for j in range(view1.extent(2)):
            for k in range(view1.extent(3)):
                for l in range(view1.extent(4)):
                    out[tid][i][j][k][l] = (
                        view1[tid][i][j][k][l] == view2[tid][i][j][k][l]
                    )


@pk.workunit
def equal_impl_5d_float(
    tid: int,
...
@pk.workunit
def floor_impl_3d_double(
    tid: int, view: pk.View3D[pk.double], out: pk.View3D[pk.double]
):
    for i in range(view.extent(1)):
...
@pk.workunit
def isnan_impl_2d_double(
    tid: int, view: pk.View2D[pk.double], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):
...
@pk.workunit
def isnan_impl_2d_uint16(
    tid: int, view: pk.View2D[pk.uint16], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):
        out[tid][i] = isnan(view[tid][i])
...
@pk.workunit
def isnan_impl_2d_uint32(
    tid: int, view: pk.View2D[pk.uint32], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):
        out[tid][i] = isnan(view[tid][i])
...
@pk.workunit
def isnan_impl_2d_uint64(
    tid: int, view: pk.View2D[pk.uint64], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):
        out[tid][i] = isnan(view[tid][i])
...
@pk.workunit
def isnan_impl_1d_uint16(
    tid: int, view: pk.View1D[pk.uint16], out: pk.View1D[pk.uint8]
):
    out[tid] = isnan(view[tid])


@pk.workunit
def isnan_impl_1d_uint32(
    tid: int, view: pk.View1D[pk.uint32], out: pk.View1D[pk.uint8]
):
    out[tid] = isnan(view[tid])


@pk.workunit
def isnan_impl_1d_uint64(
    tid: int, view: pk.View1D[pk.uint64], out: pk.View1D[pk.uint8]
):
    out[tid] = isnan(view[tid])
...
@pk.workunit
def isfinite_impl_2d_float(
    tid: int, view: pk.View2D[pk.float], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):  # type: ignore
        out[tid][i] = isfinite(view[tid][i])  # type: ignore
...
@pk.workunit
def isfinite_impl_1d_uint8(
    tid: int, view: pk.View1D[pk.uint8], out: pk.View1D[pk.uint8]
):
    out[tid] = isfinite(view[tid])


@pk.workunit
def isfinite_impl_2d_uint8(
    tid: int, view: pk.View2D[pk.uint8], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):  # type: ignore
        out[tid][i] = isfinite(view[tid][i])  # type: ignore
...
@pk.workunit
def isfinite_impl_1d_int16(
    tid: int, view: pk.View1D[pk.int16], out: pk.View1D[pk.uint8]
):
    out[tid] = isfinite(view[tid])


@pk.workunit
def isfinite_impl_2d_int16(
    tid: int, view: pk.View2D[pk.int16], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):  # type: ignore
        out[tid][i] = isfinite(view[tid][i])  # type: ignore
...
@pk.workunit
def isfinite_impl_1d_int32(
    tid: int, view: pk.View1D[pk.int32], out: pk.View1D[pk.uint8]
):
    out[tid] = isfinite(view[tid])


@pk.workunit
def isfinite_impl_2d_int32(
    tid: int, view: pk.View2D[pk.int32], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):  # type: ignore
        out[tid][i] = isfinite(view[tid][i])  # type: ignore
...
@pk.workunit
def isfinite_impl_1d_int64(
    tid: int, view: pk.View1D[pk.int64], out: pk.View1D[pk.uint8]
):
    out[tid] = isfinite(view[tid])


@pk.workunit
def isfinite_impl_2d_int64(
    tid: int, view: pk.View2D[pk.int64], out: pk.View2D[pk.uint8]
):
    for i in range(view.extent(1)):  # type: ignore
        out[tid][i] = isfinite(view[tid][i])  # type: ignore
...
@pk.workunit
def matmul_impl_1d_float(
    tid: int,
    acc: pk.Acc[pk.float],
    viewA: pk.View1D[pk.float],
    viewB: pk.View2D[pk.float],
):
    acc += viewA[tid] * viewB[0][tid]

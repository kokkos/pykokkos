...
class MathExtra:
    ...
    @classmethod
    def scaleadd3(
        cls, s: float, v1: List[float], v2: List[float], ans: List[float]
    ) -> None:
        ans[0] = s * v1[0] + v2[0]
        ans[1] = s * v1[1] + v2[1]
        ans[2] = s * v1[2] + v2[2]
    ...
    @classmethod
    def col2mat(
        cls, ex: List[float], ey: List[float], ez: List[float], m: List[List[float]]
    ) -> None:
        m[0][0] = ex[0]
        m[1][0] = ex[1]
        m[2][0] = ex[2]
    ...
    @classmethod
    def diag_times3(
        cls, d: List[float], m: List[List[float]], ans: List[List[float]]
    ) -> None:
        ans[0][0] = d[0] * m[0][0]
        ans[0][1] = d[0] * m[0][1]
        ans[0][2] = d[0] * m[0][2]
    ...
    @classmethod
    def times3_diag(
        cls, m: List[List[float]], d: List[float], ans: List[List[float]]
    ) -> None:
        ans[0][0] = m[0][0] * d[0]
        ans[0][1] = m[0][1] * d[1]
        ans[0][2] = m[0][2] * d[2]
    ...
    @classmethod
    def plus3(
        cls, m: List[List[float]], m2: List[List[float]], ans: List[List[float]]
    ) -> None:
    ...
    def transpose_matvec(
        cls, m: List[List[float]], v: List[float], ans: List[float]
    ) -> None:
    ...
    @classmethod
    def multiply_shape_shape(
        cls, one: List[float], two: List[float], ans: List[float]
    ) -> None:
        ans[0] = one[0] * two[0]
        ans[1] = one[1] * two[1]
        ans[2] = one[2] * two[2]
